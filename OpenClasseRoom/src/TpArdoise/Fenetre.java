...
public class Fenetre extends JFrame {
  ...
  JButton square = new JButton(new ImageIcon("carreN.png")),
    circle = new JButton(new ImageIcon("rondN.png")),
    red = new JButton(new ImageIcon("btR.png")),
    green = new JButton(new ImageIcon("btV.png")),
    blue = new JButton(new ImageIcon("btB.png"));

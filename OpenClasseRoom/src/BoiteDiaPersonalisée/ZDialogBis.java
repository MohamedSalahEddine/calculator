...
public class ZDialogBis extends JDialog {
  private ZDialogInfoBis zInfo = new ZDialogInfoBis();
  ...
  public ZDialogBis(JFrame parent, String title, boolean modal){
  ...
  private void initComponent(){
    ...
    okBouton.addActionListener(new ActionListener(){
      public void actionPerformed(ActionEvent arg0) {        
        zInfo = new ZDialogInfoBis(nom.getText(), (String)sexe.getSelectedItem(), getAge(), (String)cheveux.getSelectedItem() ,getTaille());
        setVisible(false);
      }
  ...
  public ZDialogInfoBis showZDialogBis(){
	    this.sendData = false;
